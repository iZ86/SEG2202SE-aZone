...
export default function Timetable({headerBgColor = "bg-white"}: {headerBgColor?: string}) {
    ...
    <div className="overflow-x-auto">
      <div className="grid grid-cols-7 gap-x-36 gap-y-6 xl:gap-6 min-w-[700px]">
        {days.map((days) => (
          <div
            key={days}
            className={`text-black font-semibold ${headerBgColor} py-3 rounded-t-lg text-center min-w-32`}
          >
            {days}
          </div>
        ))}
