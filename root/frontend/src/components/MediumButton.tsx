...
export default function MediumButton({
  ...
  const commonClasses = `font-nunito-sans px-6 py-1.5 ${backgroundColor} ${textColor} font-bold text-xl flex justify-center items-center rounded-md ${hoverBgColor} ${borderColor.length === 0 ? "" : "border-2 " + borderColor} cursor-pointer`
