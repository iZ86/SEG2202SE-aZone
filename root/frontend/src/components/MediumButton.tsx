...
export default function MediumButton({
  ...
  const commonClasses = `px-4 py-1.5 ${backgroundColor} ${textColor} font-bold text-xl flex justify-center items-center rounded-xl ${hoverBgColor} ${borderColor.length === 0 ? "" : "border-2 " + borderColor} cursor-pointer`
