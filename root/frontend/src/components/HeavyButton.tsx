...
export default function HeavyButton({
  ...
  const commonClasses = `px-4 min-h-12 ${backgroundColor} ${textColor} font-semibold text-2xl flex justify-center items-center rounded-2xl ${hoverBgColor} ${borderColor.length === 0 ? "" : "border-2 " + borderColor} cursor-pointer`
