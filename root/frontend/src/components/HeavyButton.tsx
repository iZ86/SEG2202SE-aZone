...
export default function HeavyButton({
  ...
  const commonClasses = `px-8 py-4 ${backgroundColor} ${textColor} font-bold text-2xl flex justify-center items-center rounded-2xl ${hoverBgColor} ${borderColor.length === 0 ? "" : "border-2 " + borderColor} cursor-pointer`
