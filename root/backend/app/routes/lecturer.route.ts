...
import { createAndUpdateLecturerBodyValidator, lecturerParamValidator, lecturerTitleParamValidator, getLecturersQueryValidator } from "../validators/lecturer-validator";
...
class LecturerRoute {
  ...
  initializeRoutes() {
    ...
    this.router.post("/", checkAuthTokenHeader, verifyAuthTokenHeader, verifyAdminAuthToken, verifyAuthToken, createAndUpdateLecturerBodyValidator, asyncHandler(this.controller.createLecturer));

    this.router.put("/:lecturerId", checkAuthTokenHeader, verifyAuthTokenHeader, verifyAdminAuthToken, verifyAuthToken, lecturerParamValidator, createAndUpdateLecturerBodyValidator, asyncHandler(this.controller.updateLecturerById));
