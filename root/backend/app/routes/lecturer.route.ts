...
import { createLecturerBodyValidator, updateLecturerBodyValidator, lecturerParamValidator, lecturerTitleParamValidator, getLecturersQueryValidator } from "../validators/lecturer-validator";
...
class LecturerRoute {
  ...
  initializeRoutes() {
    ...
    this.router.post("/", checkAuthTokenHeader, verifyAuthTokenHeader, verifyAdminAuthToken, verifyAuthToken, createLecturerBodyValidator, asyncHandler(this.controller.createLecturer));

    this.router.put("/:lecturerId", checkAuthTokenHeader, verifyAuthTokenHeader, verifyAdminAuthToken, verifyAuthToken, lecturerParamValidator, updateLecturerBodyValidator, asyncHandler(this.controller.updateLecturerById));
