...
class VenueRoute {
  ...
  initializeRoutes() {
    ...
    this.router.put("/:venueId", checkAuthTokenHeader, verifyAuthTokenHeader, verifyAdminAuthToken, verifyAuthToken, venueParamValidator, createAndUpdateVenueValidator, asyncHandler(this.controller.updateVenueById));
