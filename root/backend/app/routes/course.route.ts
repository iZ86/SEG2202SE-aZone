...
class CourseRoute {
  ...
  initializeRoutes() {
    ...
    this.router.put("/:courseId", checkAuthTokenHeader, verifyAuthTokenHeader, verifyAdminAuthToken, verifyAuthToken, courseParamValidator, updateCourseValidator, asyncHandler(this.controller.updateCourseById));
