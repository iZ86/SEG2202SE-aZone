...
import { createSubjectBodyValidator, updateSubjectBodyValidator, subjectParamValidator, getSubjectsQueryValidator, getStudentSubjectsQueryValidator } from "../validators/subject-validator";
...
class SubjectRoute {
  ...
  initializeRoutes() {
    ...
    this.router.put("/:subjectId", checkAuthTokenHeader, verifyAuthTokenHeader, verifyAdminAuthToken, verifyAuthToken, subjectParamValidator, updateSubjectBodyValidator, asyncHandler(this.controller.updateSubjectById));
