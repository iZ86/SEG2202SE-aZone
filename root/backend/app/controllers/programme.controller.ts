...
export default class ProgrammeController {
  ...
  async updateProgrammeIntakeById(req: Request, res: Response) {
    ...
    const response = await programmeService.updateProgrammeIntakeById(programmeIntakeId, programmeId, intakeId, studyModeId, semester, semesterStartDate, semesterEndDate, programmeIntakeStatusId);
